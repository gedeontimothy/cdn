...
Route::get('/link/{key}', [ReadLinkController::class, 'show'])->name('show.link.file')->where('key', '.*');
...
Route::get('/icon/{original_name}', [SvgController::class, 'show'])->name('show.svg')->where('original_name', '.*');
